package com.systemsonweb.instagramclone.Utils;
//~~~~~~~~~~~~~~~ Altered ~~~~~~~~~~~~~~~~~~~~
// 96 & 151
...
import com.systemsonweb.instagramclone.Home.HomeActivity;
import com.systemsonweb.instagramclone.Profile.AccountSettingsActivity;
import com.systemsonweb.instagramclone.R;
import com.systemsonweb.instagramclone.models.Photo;
import com.systemsonweb.instagramclone.models.User;
...
public class FirebaseMethods {
    ...
    public void uploadNewPhoto(String photoType, final String caption,final int count, final String imgUrl,
        ...
        if(photoType.equals(mContext.getString(R.string.new_photo))){
            ...
            if(bm == null){
                //bm = (Bitmap) ImageManager.getBitmap(imgUrl);
                bm = ImageManager.getBitmap(imgUrl);
                //Bitmap bitmap = ((BitmapDrawable) imageView.getDrawable()).getBitmap();
                //bm = imageLoader.loadImageSync(imageUri);
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    //Log.d("FireBase URL is ------",firebaseUrl.toString() );
        ...
        //case new profile photo
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    //Log.d("FireBase Profile URL",firebaseUrl.toString() );
